    ...
    fullstack: [
      {
        title: "Eleweight",
        url: "http://Eleweight.in",
        // imageUrl: "/images/psv.jpg",
        imageUrl:"https://example.com/images/psv.jpg",
        // videoUrl: "/videos/psv.mp4",
        videoUrl: "https://example.com/videos/psv.mp4",
        github: "https://github.com/kendrekaran/Eleweight_frontend",
        techStack: ["React", "Express", "Node.js", "MongoDB"],
      }
      ...
      //     title: "Satya Check",
      //     url: "http://Satya-check.vercel.app",
      //     imageUrl: satyacheckImg.src,
      //     videoUrl: satyacheckVideo,
      //     github: "https://github.com/21prnv/SatyaCheck",
      //     techStack: ["Next.js", "React", "Tailwind CSS", "Supabase"],
      //   },
      //   {
      ...
      //     title: "Image Clipper",
      //     url: "http://Imageclipper.vercel.app",
      //     imageUrl: imageclipperImg.src,
      //     videoUrl: imageclipperVideo,
      //     github: "https://github.com/kendrekaran/bg-remover",
      //     techStack: ["Next.js", "React", "Tailwind CSS"],
      //   },
      //   {
              ...
              <div className="bg-gray-900/50 backdrop-blur-sm rounded-xl overflow-hidden border border-gray-800/50 h-full transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/10">
                ...
                <div className="relative aspect-video overflow-hidden">
                  ...
                  <img
                    ...
                    alt={project.title}
                    className={`object-cover w-full h-full transition-opacity duration-500 ${hoveredIndex === index ? 'opacity-0' : 'opacity-100'
                      }`}
                    loading="lazy"
                  />
                  ...
                  {project.videoUrl && (
                    <video
                      ...
                      loop
                      playsInline
                      className={`absolute inset-0 object-cover w-full h-full transition-opacity duration-500 ${hoveredIndex === index ? 'opacity-100' : 'opacity-0'
                        }`}
                    >
