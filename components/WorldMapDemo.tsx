...
//   return (
//     <div className="py-20 relative flex flex-col items-center justify-center bg-black w-full overflow-hidden">
//       {/* Title and subtitle */}
...
//         {/* India Marker (placed accurately in px for fixed position) */}
//         <div
//           className="absolute flex items-center space-x-2 z-20 animate-bounce"
//           style={{
//             top: "284px", // fine-tuned to match India position in your map
//             left: "853px",
//           }}
//         >
//           {/* Glowing custom map pin SVG */}
//           <svg
//             xmlns="http://www.w3.org/2000/svg"
//             viewBox="0 0 384 512"
//             fill="#ffffff"
//             className="w-6 h-6 drop-shadow-[0_0_8px_red]"
//           >
